...
export class NotionList<T = NotionObject> extends Property {
  ...
  map(
    callback: (index: NotionNumberType | any, current: T | any) => NotionType
  ): NotionList<any> {
    return this;
  }
  ...
  slice(start: NotionNumberType, end?: NotionNumberType): NotionList<T> {
    return this;
  }
  concat(...values: NotionList<T>[]): NotionList<T> {
    return this;
  }
  reverse(): NotionList<T> {
    return this;
  }
  sort(): NotionList<T> {
    return this;
  }
  join(intermediary: NotionStringType): string {
    return '';
  }
  unique(): NotionList<T> {
    return this;
...
export class NotionString extends Property {
  ...
  length(): NotionNumber {
    return {} as NotionNumber;
  } // unfortunately, notion and typescript disagree on the type signature here. We'll add the () when we compile the formula
  substring(start: NotionNumberType, end?: NotionNumberType): NotionString {
    return this;
  }
  contains(toSearchFor: NotionStringType): boolean {
    return true;
  }
  test(toMatch: NotionStringType): boolean {
    return true;
  }
  match(regEx: NotionStringType): NotionList {
    return new NotionList();
  }
  replace(toFind: NotionStringType, toReplace: NotionStringType): NotionString {
    return this;
  }
  replaceAll(
    toFind: NotionStringType,
    toReplace: NotionStringType
  ): NotionString {
    return this;
  }
  lower(): NotionString {
  ...
  link(link: NotionStringType): NotionString {
    return this;
  }
  style(...values: StyleType[]): NotionString {
    return this;
  }
  unstyle(...values: StyleType[]): NotionString {
    return this;
  }
  toNumber(): NotionNumber {
    return {} as NotionNumber;
  }
  parseDate(): Date {
    return new Date();
  }
  split(splitter: NotionStringType): NotionList {
    return new NotionList();
  }
  padStart(
    value: string,
...
export class NotionNumber extends Property {
  ...
  mod(divisor: NotionNumber): NotionNumber {
    return this;
  }
  sqrt(): NotionNumber {
    return this;
  ...
  pow(exponent: NotionNumber): NotionNumber {
    return this;
  } // returns this as base to the exponent
  log10(): NotionNumber {
    return this;
  }
  log2(): NotionNumber {
  ...
  exp(): NotionNumber {
    return this;
  } // returns e to the this
  max(...values: NotionNumberType[]): NotionNumber {
    return this;
  }
  min(...values: NotionNumberType[]): NotionNumber {
    return this;
  }
  round(): NotionNumber {
    return this;
  }
  add(value2: NotionNumberType): NotionNumber {
    return this;
  }
  subtract(value1: NotionNumberType, value2: NotionNumberType): NotionNumber {
    return this;
  }
  sign(): NotionNumber {
    return this;
  }
  divide(denom: NotionNumberType) {
    return this;
  }
  fromTimestamp(): Date {
    return new Date();
...
export class NotionObject extends Property {
   ...
   * */
  _valueAccessor<T>(propertyName: string): T {
    return {} as T;
  }
}

export class NotionDate extends Property {
  dateSubtract(num: NotionNumberType, unit: NotionDateType): NotionDate {
    return this;
  }
  dateAdd(num: NotionNumberType, unit: NotionDateType): NotionDate {
    return this;
  }
  formatDate(format: NotionStringType): NotionString {
    return {} as NotionString;
  }
}
...
export enum NodeType {
  Logic = 'Logic', // if(statement, trueChild, falseChild)
